...
const FloatingChatButton = () => {
  ...
  const { isLoaded, isOnline, openChat } = useTawkTo();
  ...
  return (
    ...
    >
        ...
        {isExpanded && (
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-3 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-4 rounded-2xl shadow-xl hover:shadow-green-500/50 transition-all duration-300"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05, x: 5 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-6 py-4 rounded-2xl shadow-xl hover:shadow-blue-500/50 transition-all duration-300"
            >
              <div className="w-12 h-12 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
      ...
      {/* Main Button - Mejorado con WhatsApp */}
      <motion.button
        onClick={toggleExpanded}
        whileHover={{ scale: 1.05, y: -2 }}
        whileTap={{ scale: 0.98 }}
        className="group relative bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:from-green-600 hover:via-green-700 hover:to-green-800 text-white rounded-2xl shadow-2xl hover:shadow-green-500/50 transition-all duration-300 overflow-hidden"
      >
        ...
        <div className="relative flex items-center gap-3 px-5 py-4 sm:gap-5 sm:px-10 sm:py-6">
          {/* Icon container with WhatsApp icon */}
          <motion.div
            animate={{
              rotate: isExpanded ? 180 : [0, 10, -10, 0],
            }}
            transition={{
      ...
      <motion.div
        ...
        className="absolute -top-8 right-8 w-2 h-2 bg-green-400 rounded-full"
      />
      <motion.div
        animate={{
          y: [-15, -35, -15],
        ...
        className="absolute -top-6 right-16 w-1.5 h-1.5 bg-green-500 rounded-full"
      />
    </motion.div>
  );
};
